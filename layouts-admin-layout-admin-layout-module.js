...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\" content\">\r\n  <div class=\" row\">\r\n    <div class=\" col-md-12\">\r\n      <div class=\" card\">\r\n        <div class=\" card-header\">\r\n          <h4 class=\"card-title\">Notifications</h4>\r\n        </div>\r\n        <div class=\" card-body\">\r\n          <div *ngFor=\"let notification of notifications\"> \r\n            <ngb-alert\r\n              *ngIf=\"notification.enabled\"\r\n              class=\" alert-with-icon\"\r\n              data-notify=\"container\"\r\n              [type]=\"notification.notificationTypeId == notificationType.Follow ? 'success' : 'info'\"\r\n              (click)=\"handleNotification(notification, messageUserContent);\"\r\n              [dismissible]=\"false\">\r\n              <button type=\"button\" aria-hidden=\"true\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\" (click)=\"deleteNotification(notification.id); notification.enabled = false;\">\r\n                <i class=\"tim-icons icon-simple-remove\"></i>\r\n              </button>\r\n              <span [ngClass]=\"{'tim-icons': true, 'icon-bell-55': notification.notificationTypeId == notificationType.Follow, \r\n                'icon-chat-33': notification.notificationTypeId == notificationType.Message,\r\n                'icon-world': notification.notificationTypeId == notificationType.Mention}\" data-notify=\"icon\">\r\n              </span>\r\n              <span data-notify=\"message\">\r\n                <span *ngIf=\"notification.notificationTypeId != notificationType.Follow\">\r\n                  <strong>{{notification.title}}:</strong><br>\r\n                </span>\r\n                {{notification.message}}\r\n              </span>\r\n            </ngb-alert>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <ng-template #messageUserContent let-modal>\r\n    <div class=\"modal-header\">\r\n      <h3>Send a message to {{userToMessage.username}}:</h3>\r\n      <button\r\n        aria-label=\"Close\"\r\n        class=\"close\"\r\n        data-dismiss=\"modal\"\r\n        type=\"button\"\r\n        (click)=\"modal.dismiss('Cross click')\">\r\n        <i class=\"tim-icons icon-simple-remove\"> </i>\r\n      </button>\r\n    </div>\r\n    <div class=\"modal-body\">\r\n      <ngb-alert\r\n        class=\"alert-with-icon\"\r\n        data-notify=\"container\"\r\n        [type]=\"'info'\"\r\n        [dismissible]=\"false\">\r\n        <span class=\"tim-icons icon-chat-33\" data-notify=\"icon\">\r\n        </span>\r\n          {{activeNotification.message}}\r\n      </ngb-alert>\r\n      <textarea #userMessage class=\"form-control\" placeholder=\"Type a message...\"></textarea>\r\n      <button data-dismiss=\"modal\"\r\n        class=\"btn btn-dark btn-round\"\r\n        type=\"button\"\r\n        (click)=\"messageUser(userMessage.value); modal.dismiss('Cross click');\">SEND</button>\r\n      <button data-dismiss=\"modal\"\r\n        class=\"btn btn-dark btn-round\"\r\n        aria-label=\"Close\"\r\n        data-dismiss=\"modal\"\r\n        type=\"button\"\r\n        (click)=\"modal.dismiss('Cross click')\">CANCEL</button>\r\n    </div>\r\n  </ng-template>\r\n</div>\r\n");
...
/* harmony import */ var _pages_notifications_notifications_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../pages/notifications/notifications.component */ "./src/app/pages/notifications/notifications.component.ts");
...
/* harmony import */ var _pages_typography_typography_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../pages/typography/typography.component */ "./src/app/pages/typography/typography.component.ts");
    ...
    AdminLayoutModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [
                ...
                _pages_user_user_component__WEBPACK_IMPORTED_MODULE_10__["UserComponent"],
                ...
                _pages_typography_typography_component__WEBPACK_IMPORTED_MODULE_12__["TypographyComponent"],
                _pages_notifications_notifications_component__WEBPACK_IMPORTED_MODULE_9__["NotificationsComponent"]
            ],
...
/* harmony import */ var src_app_pages_streamer_tools_streamer_tools_streamer_tools_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/pages/streamer-tools/streamer-tools/streamer-tools.component */ "./src/app/pages/streamer-tools/streamer-tools/streamer-tools.component.ts");
/* harmony import */ var src_app_pages_streamer_tools_prize_wheel_prize_wheel_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/pages/streamer-tools/prize-wheel/prize-wheel.component */ "./src/app/pages/streamer-tools/prize-wheel/prize-wheel.component.ts");
/* harmony import */ var src_app_pages_streamer_tools_leaderboard_leaderboard_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/pages/streamer-tools/leaderboard/leaderboard.component */ "./src/app/pages/streamer-tools/leaderboard/leaderboard.component.ts");
/* harmony import */ var src_app_pages_forum_forum_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/pages/forum/forum.component */ "./src/app/pages/forum/forum.component.ts");
...
var AdminLayoutRoutes = [
    ...
    { path: "streamer-tools", component: src_app_pages_streamer_tools_streamer_tools_streamer_tools_component__WEBPACK_IMPORTED_MODULE_6__["StreamerToolsComponent"] },
    { path: "prize-wheel", component: src_app_pages_streamer_tools_prize_wheel_prize_wheel_component__WEBPACK_IMPORTED_MODULE_7__["PrizeWheelComponent"] },
    { path: "leaderboard", component: src_app_pages_streamer_tools_leaderboard_leaderboard_component__WEBPACK_IMPORTED_MODULE_8__["LeaderboardComponent"] },
    { path: "forum", component: src_app_pages_forum_forum_component__WEBPACK_IMPORTED_MODULE_9__["ForumComponent"] },
...
/* harmony import */ var src_app_services_twitch_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/twitch.service */ "./src/app/services/twitch.service.ts");
...
/* harmony import */ var src_app_enums_notification_type__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/enums/notification-type */ "./src/app/enums/notification-type.ts");
...
var NotificationsComponent = /** @class */ (function () {
    function NotificationsComponent(toastr, twitchService, router, zone, sharedService, modalService) {
        this.toastr = toastr;
    ...
    Object.defineProperty(NotificationsComponent.prototype, "notificationType", {
        get: function () {
            return src_app_enums_notification_type__WEBPACK_IMPORTED_MODULE_7__["NotificationType"];
        },
        enumerable: true,
        configurable: true
    });
    ...
    NotificationsComponent.prototype.deleteNotification = function (id) {
        this.twitchService.deleteNotification(id).subscribe(function (data) { }, function (err) { });
    };
    NotificationsComponent.prototype.handleNotification = function (notification, messageUserContent) {
        if (notification.notificationTypeId == src_app_enums_notification_type__WEBPACK_IMPORTED_MODULE_7__["NotificationType"].Follow) {
            this.searchNotification(notification);
            notification.enabled = false;
        }
        else if (notification.notificationTypeId == src_app_enums_notification_type__WEBPACK_IMPORTED_MODULE_7__["NotificationType"].Message) {
            this.activeNotification = notification;
            this.openMessageModal(messageUserContent, notification.follower);
        }
        else if (notification.notificationTypeId == src_app_enums_notification_type__WEBPACK_IMPORTED_MODULE_7__["NotificationType"].Mention) {
            this.router.navigate(['./forum']);
            notification.enabled = false;
            this.deleteNotification(notification.id);
        }
    };
    NotificationsComponent.prototype.searchNotification = function (notification) {
        var _this = this;
        sessionStorage.setItem('query', notification.follower.username);
        this.deleteNotification(notification.id);
        this.zone.run(function () { return _this.router.navigate(['/dashboard']); });
    };
    NotificationsComponent.prototype.openMessageModal = function (content, user) {
        this.modalService.open(content, {
            windowClass: 'modal-search'
        }).result.then(function (result) { }, function (reason) { });
        this.userToMessage = user;
    };
    NotificationsComponent.prototype.messageUser = function (userMessage) {
        var _this = this;
        this.activeNotification.enabled = false;
        this.deleteNotification(this.activeNotification.id);
        var messageNotification = {
            fromUserId: localStorage.getItem('userId'),
            toUserId: this.userToMessage.userId,
            message: userMessage
        };
        this.twitchService.messageUser(messageNotification).subscribe(function () {
            _this.toastr.info("Message sent to " + _this.userToMessage.username + ".");
        }, function (err) {
            _this.toastr.error('Unable to message user.', 'Error');
        });
    };
    NotificationsComponent.ctorParameters = function () { return [
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"] },
        { type: src_app_services_twitch_service__WEBPACK_IMPORTED_MODULE_3__["TwitchService"] },
    ...
    NotificationsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"],
            src_app_services_twitch_service__WEBPACK_IMPORTED_MODULE_3__["TwitchService"],
